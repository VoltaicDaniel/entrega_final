# -*- coding: utf-8 -*-
"""
Created on Sat May 18 20:33:48 2019
...
class Proyectil(pygame.sprite.Sprite):
    def __init__(self,posx,posy,ruta,personaje):
        ...
        self.pequeproyectil = pygame.transform.scale(self.imagenProyectil,(100,100))

        self.rect = self.pequeproyectil.get_rect()
    ...
    def dibujar(self,superficie):
        superficie.blit(self.pequeproyectil,self.rect)
...
class Enemigos(pygame.sprite.Sprite):
    def __init__(self,posx,posy,distancia,imagenUno,imagenDos):
        ...
        self.imagenA =  pygame.transform.scale(self.imagenA,(100,100))

        """ enemigo de aire"""
        self.imagenB = pygame.image.load(imagenDos)
        self.imagenB = pygame.transform.scale(self.imagenB,(100,100))
...
def goldTraver():
    ...
    while True:
        ...
        """ me permite configurar la imagen el ancho y el alto de la imagen"""
        imagenFondo = pygame.transform.scale(imagenFondo, (1000, 650))
...
#
#
#        mundo.cargarMapa(mundo,"mapaDesierto")
            ...
            if enJuego == True: #se usa para saber si el jugador no ha perdido
                ...
                if evento.type ==pygame.KEYUP:
                    if evento.key == 273:
                        ...
                        perdida = pygame.image.load("GAMEOVER.png").convert_alpha()
                        """ me permite configurar la imagen el ancho y el alto de la imagen"""
                        perdida = pygame.transform.scale(perdida, (1000, 650))
